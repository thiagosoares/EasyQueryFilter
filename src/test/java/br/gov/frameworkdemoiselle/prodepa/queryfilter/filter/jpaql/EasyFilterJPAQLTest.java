package br.gov.frameworkdemoiselle.prodepa.queryfilter.filter.jpaql;
...
import br.gov.frameworkdemoiselle.prodepa.queryfilter.filter.EasyQueryJPAQLImpl;
...
public class EasyFilterJPAQLTest extends AbstractTest {
  ...
  public void testFindAll() {
    ...
    EasyQuery<Person> easyCriteria = new EasyQueryJPAQLImpl<Person>(Person.class, getEntityManager());
  ...
  public void isListingAll() {
    ...
    public void isAddingSequentialWhereEquals() throws ParseException {
        ...
        EasyQuery<Address> easyCriteria = new EasyQueryJPAQLImpl<Address>(Address.class, getEntityManager());
    ...
    public void isNullWorking() {
        ...
        EasyQuery<Person> personCriteria1 = new EasyQueryJPAQLImpl<Person>(Person.class, getEntityManager());
    ...
    public void isEqualsLowerCaseWorking(){
        ...
        easyCriteria = new EasyQueryJPAQLImpl<Person>(Person.class, getEntityManager());
