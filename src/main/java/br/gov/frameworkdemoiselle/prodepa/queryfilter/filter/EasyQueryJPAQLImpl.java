...
public class EasyQueryJPAQLImpl<T> implements EasyQuery<T> {
	...
	public EasyQueryJPAQLImpl(Class<T> beanClass, EntityManager em) {
		super();
		...
		this.andConditions = new ArrayList<EasyQueryJPAQLImpl<T>.Condition>();
		this.orConditions = new ArrayList<EasyQueryJPAQLImpl<T>.Condition>();
